...
enum TextureId { MCBullet, GunnerBullet, HookChain, HookChainFail, HookHead, Blood, SwordButton, GunButton, MemexButton, MaxAttackButton, SwordChargeButton, CoinSprite};
