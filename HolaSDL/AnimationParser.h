...
public:
	static Animation* parseAnimation(string animationFile, string animationName, GameObject* o, int row, int firstCol, int lastCol, int w, int h, bool loop=true, float time=0.05);
};
